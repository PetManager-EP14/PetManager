...
public class sale {
    ...
    public sale(Long sale_id, com.ep14.pet_manager.entity.user user, OffsetDateTime date, payment_method method,
            sale_status status, BigDecimal total, OffsetDateTime created_at, OffsetDateTime updated_at) {
